...
async def addchannel(client: hellbot, message: Message):
    ...
    try:
        ...
        await message.reply_text(
            "<b><i>Make sure I'm admin with invite users permission...😥</b></i>"
        )
        return
    try:
    ...
    try:
        ...
        await USER.send_message(
            message.chat.id, "<b><i>Okay!! Let's start music now?</b></i>"
        )
